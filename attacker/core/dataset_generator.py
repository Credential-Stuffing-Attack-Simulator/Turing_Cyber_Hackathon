...
# Paths
OUTPUT_FILE = Path("configs/credentials.txt")
...
def generate_dataset(num_records=65):
    ...
    print(f"[*] Auto-generating new dynamic dataset: {num_records} pairs")
    print(f"[*] Dynamically injecting {num_to_inject} valid accounts for this attack run")
    ...
    return num_records, num_to_inject
